...
public class CapRIL {
    ...
    private IBase getMtkRadioExProxy(Message result) {
        ...
        try {
            mRadioProxyMtk =
                    (vendor.mediatek.hardware.mtkradioex.V3_0.IMtkRadioEx)
                    vendor.mediatek.hardware.mtkradioex.V3_0.IMtkRadioEx.getService(
                    HIDL_SERVICE_NAME_MTK[mPhoneId], false);
        } catch (RemoteException | RuntimeException e) {
            mRadioProxyMtk = null;
            Rlog.e(LOG_TAG, "MtkRadioExProxy getServiceV3_0: " + e);
        }

        if (mRadioProxyMtk != null) {
            try {
                mRadioProxyMtk = (vendor.mediatek.hardware.mtkradioex.V3_0.IMtkRadioEx)
                        vendor.mediatek.hardware.mtkradioex.V3_0.IMtkRadioEx
                        .castFrom(mRadioProxyMtk);
                mRadioVersionMtk = RADIO_HAL_VERSION_MTK_3_0;
                ((vendor.mediatek.hardware.mtkradioex.V3_0.IMtkRadioEx)mRadioProxyMtk)
                        .linkToDeath(mCapRadioProxyDeathRecipient,
                        mRadioProxyCookie.incrementAndGet());
                ((vendor.mediatek.hardware.mtkradioex.V3_0.IMtkRadioEx)mRadioProxyMtk)
                        .setResponseFunctionsCap(mCapRadioResponse);
            } catch (RemoteException | RuntimeException e) {
                mRadioProxyMtk = null;
                Rlog.e(LOG_TAG, "MtkRadioExProxy setResponseFunctionsMtkV3_0: " + e);
            }
        } else {
            try {
                mRadioProxyMtk =
                        (vendor.mediatek.hardware.mtkradioex.V2_0.IMtkRadioEx)
                        vendor.mediatek.hardware.mtkradioex.V2_0.IMtkRadioEx.getService(
                        HIDL_SERVICE_NAME_MTK[mPhoneId], false);
            } catch (RemoteException | RuntimeException e) {
                mRadioProxyMtk = null;
                Rlog.e(LOG_TAG, "MtkRadioExProxy getServiceV2_0/setResponseFunctions: " + e);
            }
            if (mRadioProxyMtk != null) {
                try {
                    if (vendor.mediatek.hardware.mtkradioex.V2_0.IMtkRadioEx.castFrom(
                            mRadioProxyMtk) != null) {
                        mRadioProxyMtk = (vendor.mediatek.hardware.mtkradioex.V2_0.IMtkRadioEx)
                                vendor.mediatek.hardware.mtkradioex.V2_0.IMtkRadioEx
                                .castFrom(mRadioProxyMtk);
                        mRadioVersionMtk = RADIO_HAL_VERSION_MTK_2_0;
                    }
                    ((vendor.mediatek.hardware.mtkradioex.V2_0.IMtkRadioEx)mRadioProxyMtk)
                            .linkToDeath(mCapRadioProxyDeathRecipient,
                            mRadioProxyCookie.incrementAndGet());
                    if (mCapRadioResponseV2 == null) {
                        mCapRadioResponseV2 = new CapRadioResponseV2(this);
                    }
                    ((vendor.mediatek.hardware.mtkradioex.V2_0.IMtkRadioEx)mRadioProxyMtk)
                            .setResponseFunctionsCap(mCapRadioResponseV2);
                } catch (RemoteException | RuntimeException e) {
                    mRadioProxyMtk = null;
                    Rlog.e(LOG_TAG, "MtkRadioExProxy setResponseFunctionsV2: " + e);
                }
            }
        }
    ...
    public void routeCertificate(CertRequestInfo request, Message result) {
        ...
        if (radioProxy != null) {
            ...
            try {
                if (mRadioVersionMtk.greaterOrEqual(RADIO_HAL_VERSION_MTK_3_0)) {
                    (((vendor.mediatek.hardware.mtkradioex.V3_0.IMtkRadioEx)radioProxy))
                            .routeCertificate(rr.mSerial, request.mCallerId, certArrList,
                            msgArrList);
                } else {
                    (((vendor.mediatek.hardware.mtkradioex.V2_0.IMtkRadioEx)radioProxy))
                            .routeCertificate(rr.mSerial, request.mCallerId, certArrList,
                            msgArrList);
                }
            } catch (RemoteException | RuntimeException e) {
    ...
    public void routeAuthMessage(AuthRequestInfo request, Message result) {
        ...
        if (radioProxy != null) {
            ...
            try {
                if (mRadioVersionMtk.greaterOrEqual(RADIO_HAL_VERSION_MTK_3_0)) {
                    (((vendor.mediatek.hardware.mtkradioex.V3_0.IMtkRadioEx)radioProxy))
                            .routeAuthMessage(rr.mSerial, request.mCallerId, msgArrList);
                } else {
                    (((vendor.mediatek.hardware.mtkradioex.V2_0.IMtkRadioEx)radioProxy))
                            .routeAuthMessage(rr.mSerial, request.mCallerId, msgArrList);
                }
    ...
    public void enableCapability(EnableCapabilityRequestInfo request, Message result) {
        ...
        if (radioProxy != null) {
            ...
            try {
                if (mRadioVersionMtk.greaterOrEqual(RADIO_HAL_VERSION_MTK_3_0)) {
                    (((vendor.mediatek.hardware.mtkradioex.V3_0.IMtkRadioEx)radioProxy))
                            .enableCapabaility(rr.mSerial, 
                            convertNullToEmptyString(request.mFeatureName),
                            request.mCallerId,
                            request.mToActive);
                } else {
                    (((vendor.mediatek.hardware.mtkradioex.V2_0.IMtkRadioEx)radioProxy))
    ...
    public void abortCertificate(int uid, Message result) {
        ...
        if (radioProxy != null) {
            ...
            try {
                if (mRadioVersionMtk.greaterOrEqual(RADIO_HAL_VERSION_MTK_3_0)) {
                    (((vendor.mediatek.hardware.mtkradioex.V3_0.IMtkRadioEx)radioProxy))
                            .abortCertificate(rr.mSerial, uid);
                } else {
                    (((vendor.mediatek.hardware.mtkradioex.V2_0.IMtkRadioEx)radioProxy))
                            .abortCertificate(rr.mSerial, uid);
                }
    ...
    public void processResponseDone(RILRequest rr, RadioResponseInfo responseInfo, Object ret) {
        if (rr == null) {
            Rlog.d(LOG_TAG, "processResponseDone: Unexpected request!");
            return;
        }
